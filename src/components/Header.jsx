...
function Header(props) {
  ...
  return (
    <HeaderWrapper showCart={props.count !== 0}>
      <div className='flex'>
        <div className='flex'>
          <img id='menu' src="images/icon-menu.svg" alt="menu icon" onClick={_ => setShow(true)} className='clickable' />
          <img src="images/logo.png" alt="logo" width="60" height="60"/>
        </div>
        <Navbar show={show} closeNav={_ => setShow(false)}/>
      </div>
      <div className='flex'>
        <div id='cart-icon' className='clickable' onClick={props.toggleCart}>
